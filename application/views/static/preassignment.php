<div class="panel">
	<h4>What does pre-assignment mean in general and to FroSoCo residents?</h4>
	...
	<h4>General requirements for pre-assignment</h4>
	...
	<h4>Tier Requirement</h4>
	<p>Pre-assignment to FroSoCo will REQUIRE the use of a TIER THREE housing choice.</p>
	<h5>FroSoCo-specific requirements</h5>
	<p>Pre-assignment to FroSoCo will be considered for students who fulfill ANY of the following conditions:</p>
	<ol>
		<li>A current freshman who is returning to FroSoCo for his/her Sophomore Year. Current FroSoCo residents are guaranteed a space should they choose to stay at FroSoCo</li>
		<li>An incoming sophomore being sponsored by a current FroSoCo Resident who is returning to FroSoCo for his/her Sophomore Year. Current non-FroSoCo freshmen choosing to be pre-assigned to FroSoCo by being sponsored are required to answer one short essay question, outlining the reasons for why they wish to live in FroSoCo. Current FroSoCo students sponsoring other freshmen may, but are not obligated to room with the person they sponsor</li>
		<li>An incoming sophomore who has a special interest in being a part of the FroSoCo community. Current non-FroSoCo non-sponsored freshmen who wish to be pre-assigned to FroSoCo are required to answer two short essay questions, outlining the reasons for why they wish to live in FroSoCo</li>
	</ol>
	<h4>Pre-assignment policies</h4>
	<ul>
		<li>Students may only apply for pre-assignment to one house</li>
		<li>If students are selected for a pre-assignment spot in a house, they are automatically assigned to the house and are not eligible to apply for the Housing Draw. Note: You must still file a housing application and list the pre-assigned house as your only choice.</li>
		<li>Students who are pre-assigned must use a guaranteed year of housing and the tier designated for each house. FroSoCo requires the use of a Tier-3 housing option.</li>
	</ul>
	<h4>Are you ready to apply for pre-assignment?</h4>
	<p>You can apply for pre-assignment by submitting an application through the ResJobs website at <a href="http://sawebapp.stanford.edu/resjobs/">http://sawebapp.stanford.edu/resjobs/</a></p>
	...
	<p>The deadline for submitting an application for pre-assignment is 11:59 p.m. on April 14, 2014.</p>
	<h4>Housing at-a-glance</h4>
	...
	<h4>Freshman-Sophomore College Housing Process Timeline</h4>
	<p>Pre-assignment applications available on ResJobs on Friday, February 28, 2014: <a href="https://sawebapp.stanford.edu/resjobs/">https://sawebapp.stanford.edu/resjobs/</a></p>
	...
	<p><strong>FROSOCO'S PREASSIGNMENT OPEN HOUSE BBQ IS ON Friday, April 4, 2014 (5:30-7:30PM at the Dean's House)</strong></p>
	<p>Pre-assignment applications due at 11:59 p.m. on April 14, 2014: <a href="http://sawebapp.stanford.edu/resjobs/">http://sawebapp.stanford.edu/resjobs/</a>
	<p>Check for Pre-assignment offer on ResJobs at <a href="http://sawebapp.stanford.edu/resjobs/">https://sawebapp.stanford.edu/resjobs/</a> Tuesday, April 29, 2014 between 8 a.m.-5 p.m. Use the link above to check if you have been pre-assigned. If you have been pre-assigned, you will be exempted from The Draw &amp; automatically placed into the house to which you have applied. Again, once accepted, you CANNOT decline an offer.</p>
	<p>May 1, 2014: OAE Assignments announced</p>
</div>
<div class="panel">
	<h4>Useful links for information about pre-assignment and housing</h4>
	...
	<div class="alert alert-info">
		...
		<p><a href="/assets/documents/2014_15_FSCPreassignmentFAQs.pdf">2014-15 FSC Preassignment FAQs</a></p>
		<p><a href="/assets/documents/2014_15PreAssignment_Info.pdf">2014-15 FSC Preassignment Info</a></p>
	</div>
</div>
</div>
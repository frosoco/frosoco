...
<div class="row bio">
    <div class="panel home">
        <p>
           Our College includes 22 professional and student staff members. 
           Each of these professionals is deeply committed to undergraduate education and the purposes of the College. 
           The same is certainly true of this year's outstanding student staff.
       </p>
       <p>
           Each of the two houses offers four upper-class undergraduates serving as College Assistants (CAs),
           and a live-in, professional couple serving as College Directors (CDs). 
           Across the College we have students serving as Residence Computer Coordinators (RCCs), 
           a Resident Multimedia Consultant (RMC), an Oral Communications Tutor (OCT), 
           and a Peer Health Educator (PHE). There is an extended staff of academic advisors 
           (faculty or professional staff), such as a College-specific Academic Director (AD). 
           Our Residence Dean (RD) handles student mental health and behavioral issues.  
           The College's staff is rounded out by the Residential Programs Manager (RPM). 
           The College is led by the Dean of the Freshman-Sophomore College.
       </p>
   </div>

   <div class="panel pic">
        <img src="/assets/images/seniorstaff.jpg" />
        <div class="caption">
            <p>
             From left to right: Bryan Brown, Cheryl Brown, Pauline Larmaraud, Nadeem Hussain, Lacona Woltmon. 
         </p>
        </div>
    </div>
</div><!--section -->
...
<div class="row bio">
 <div class="panel home">
   <h2>Lisa De La Cruz-Caldera</h2>
   <h4>Residence Dean</h4>
   <p>Lisa De La Cruz-Caldera serves as the Residence Dean (RD) at FroSoCo.  As an RD, Lisa works to support you as you experience Stanford in both academic and personal ways.  Lisa regularly works to assist students as they experience the on-going transitions during college which can often include a wide variety of issues and/or needs.  As a doctoral student at Azusa Pacific University, some of her current professional areas of interest include access and equity in higher education, policy analysis, socioeconomic disparities, and resilience in ethnic minority student populations.  As we celebrate the coming of a new academic year, Lisa is honored to serve as your RD who will work to fill both your individual and communal needs.  Lisa looks forward to our collaborative efforts towards bountiful experiences in the months to come!</p>
</div>
<div class="panel pic">
    <img src="/assets/images/seniorstaff/Lisa_De_La_Cruz-Caldera.jpg"  />
    <div class="caption">
        <p>Lisa De La Cruz-Caldera</p>
    </div>
</div>
</div>

...
<div class=" section">
	<div class="panel housing">
		...
		You will be assigned to either Adams or Schiff, both of which house freshmen and sophomores. The rooms range from singles
		(usually taken by the sophomores), to two-room doubles, to one-room doubles, to a triple. 
		An adjacent dining hall, Ricker, serves both the College and two other houses. Lagunita Lakeside dining is also a few minutes walk away.
		 </p>
	...
	<div class="panel">
		<p>
			<b>Address</b> (NOT your mailing address!):
		</p>
		...
		<div style="width:400px;height:300px;margin-top:20px;"><iframe width="400" height="300" frameborder="0" scrolling="no" marginheight="0" marginwidth="0" src="https://maps.google.com/maps?f=q&source=s_q&hl=en&geocode=&q=Sterling%2BQuad%2BStanford%2C%2BCA(FroSoCo)&ie=UTF8&z=18&t=m&iwloc=addr&output=embed"></iframe></div></p>
	</div>
</div><!--section-->

<!doctype html>
	...
	<head>
		...
		<!-- css -->
		<link href='https://fonts.googleapis.com/css?family=Lato:400|Source+Sans+Pro:300,700,900|Crimson+Text:400' rel='stylesheet' type='text/css'>
						...
						<li ><a href="#" >Do</a>
							<ul class='submenu'>
								...
								<? if ($this->session->userdata('id')) { ?>
									...
									<li>
										<a href='https://docs.google.com/a/stanford.edu/forms/d/1g0qyruyUGXdKkcwvFiuzVBI6l2XDT-OeUSTUJZdyFD4/viewform?usp=send_form'>
											Tip Box
										</a>
									</li>
								<? }?>

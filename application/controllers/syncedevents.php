...
class Syncedevents extends CI_Controller {
	...
	public function view($id)
	{
	    ...
	    while (preg_match($keyPattern, $responseText, $matches)){
	    	...
	    	$value = $responseText;
	    	//substr($responseText, 0, strpos($responseText, ","));
		...
		// $data['user_responses'] = [username1 -> ['userData' -> $user1, 'responseData -> [date -> v1, going -> v2, key3 -> v3, ..., keyn -> vn]], username2 -> ['userData' -> $user2, 'responseData'], ... ]
